...
import { HeaderControl, SideNavControl } from '@wvs-play-win-workspace/shared/types';
...
export class DashboardComponent implements OnInit {
  ...
  constructor (private breakpointObserver: BreakpointObserver, private readonly authenticationFacadeService: AuthenticationFacadeService) {}
  ngOnInit (): void {
    
    this.authenticationFacadeService.validate().subscribe(value => console.log(value));
